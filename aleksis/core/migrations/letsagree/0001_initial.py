    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_de', models.CharField(blank=True, db_index=True, max_length=63, verbose_name='Title')),
                ('title_en', models.CharField(blank=True, db_index=True, max_length=63, verbose_name='Title')),
                ('title_fr', models.CharField(blank=True, db_index=True, max_length=63, verbose_name='Title')),
                ('summary_de', models.TextField(blank=True, verbose_name='Summary')),
                ('summary_en', models.TextField(blank=True, verbose_name='Summary')),
                ('summary_fr', models.TextField(blank=True, verbose_name='Summary')),
                ('content_de', models.TextField(blank=True, verbose_name='Terms and Conditions')),
                ('content_en', models.TextField(blank=True, verbose_name='Terms and Conditions')),
                ('content_fr', models.TextField(blank=True, verbose_name='Terms and Conditions')),
