...
urlpatterns = [
    ...
    path("school_term/create/", views.SchoolTermCreateView.as_view(), name="create_school_term"),
    path("school_term/<int:pk>/", views.SchoolTermEditView.as_view(), name="edit_school_term"),
